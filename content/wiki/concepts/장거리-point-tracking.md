...
- **SpatialTracker**: 2D가 아닌 **3D 공간에서** 추적. 다만 예측이 프레임 좌표계(frame space)에 머물러 카메라·객체 모션이 얽힘.
...
## 관련
- **연구 노트(다른 영역)**: [[ShapeOfMotion]](입력 prior·최적화 융합) · [[MoVieS]]·[[DGS-LRM]]·[[POMATO]](평가·대조) · [[VGGT]]·[[NeoVerse]]·[[C4G]](부가 출력).
