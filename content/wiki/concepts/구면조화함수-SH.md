...
구(球) 위에서 정의되는 직교 기저 함수족. **방향(view direction)에 따라 변하는 값**을 소수의 계수로 압축 표현할 때 쓴다. 방사장 연구에서는 **시점의존 색(view-dependent color)** 표현의 표준 도구.
...
## 관련
- [[방사장-볼륨렌더링]] — $\alpha$-blending의 색 $c_i$ 가 SH로 평가됨
